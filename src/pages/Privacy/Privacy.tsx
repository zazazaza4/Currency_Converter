...
const Privacy: FC = () => {
  const cookies = useRef<HTMLHeadingElement>(null);
  let location = useLocation();

  const getOffset = (element: HTMLHeadingElement) => {
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to ValutaApp.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to ValutaApp, accessible from{' '}
                <a
                  href="https://github.com/zazazaza4"
                  rel="noreferrer"
                  target="_blank"
                >
                  https://github.com/zazazaza4
                </a>
              </p>
            </li>
            <li>
